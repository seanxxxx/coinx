...
class TestTwoAskEatOneBidTrade(unittest.TestCase):
    """模拟深度->挂2个价格的Ask->吃Bid（Bid一价全部交易）测试"""
    ...
    def twoAskEatOnebid(self):
        ...
        ask_req_1 = robot_fun.takeOrder('sell',
                                        deal_price_1,
                                        deal_count_1,
                                        get_basic_cfg.orderUrl,
                                        tester01_token)

        ask_req_2 = robot_fun.takeOrder('sell',
                                        deal_price_2,
                                        deal_count_2,
                                        get_basic_cfg.orderUrl,
                                        tester01_token)
        ...
        #交易总价
        deal_amount = round(deal_price_1 * deal_count_1 + deal_price_2 * deal_count_2,5)
        print("\n")
        ...
        tester02_available_USDT = round(1000000 - bid_amount + (bid_5_price - deal_price_1) * deal_count_1 + (bid_5_price - deal_price_2) * deal_count_2,5)

        tester02_reserved_USDT = round(bid_amount - bid_5_price * bid_5_count,5)
