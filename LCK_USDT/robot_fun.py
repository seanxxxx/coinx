...
def getPrice(lastPrice):
    minus = random.uniform(7000.0,7500.0)
    add = random.uniform(7000.0,7500.0)
    minusNum = (lastPrice-lastPrice*random.uniform(0.0001,0.001))/minus
    addNum = (lastPrice+lastPrice*random.uniform(0.0001,0.001))/add
...
def getMarketPrice(url):
    ...
    logging.info("----------------------------------------------------------------")
    logging.info("********** 当前LCK/USDT市场交易价格为:【%s】**********" %lastPrice)
    logging.info("----------------------------------------------------------------")
